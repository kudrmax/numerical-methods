...
\insertMyCode{python3}{../3.1.8/3.1.8.py}

\subsection{Результаты}

\insertMyCode{text}{../3.2/3.2.txt}

\begin{figure}[h]
    \includegraphics[width=0.5\linewidth]{../../3.1.8/3.1.8.png}
    \includegraphics[width=0.5\linewidth]{../../3.2/3.2.png}
\end{figure}

\input{../3.1.8/3.1.8.tex}
...
\subsubsection{Метод Гаусса для числел}
